...
const styles = StyleSheet.create({
  ...
  nav: {
    ...
    justifyContent: "space-around", padding: 7, borderRadius: 24, backgroundColor: theme.colors.glassStrong,
    borderWidth: 1, borderColor: theme.colors.glassBorder, boxShadow: theme.shadows.raised,
  },
