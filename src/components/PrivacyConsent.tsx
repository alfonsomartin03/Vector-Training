...
const styles = StyleSheet.create({
  ...
  link: { marginTop: 7, color: theme.colors.accent, fontSize: 13, fontWeight: "700" },
  actions: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  primaryButton: { minHeight: 44, justifyContent: "center", paddingHorizontal: 16, borderRadius: 13, backgroundColor: theme.colors.darkSurface },
  secondaryButton: { minHeight: 44, justifyContent: "center", paddingHorizontal: 16, borderRadius: 13, borderWidth: 1, borderColor: theme.colors.border, backgroundColor: theme.colors.glass },
